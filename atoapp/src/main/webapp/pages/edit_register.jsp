...
<body>
	...
	<section>
		...
		<article>
			...
			<form id="register_form" action="editOwnerDetails" method="post">
				<table align="center">
					<tr>
						<td>First Name</td>
						<td><input type="text" name="owner_fname" size="30" value="${o.getOwner_fname()}"/></td>
					</tr>
					<tr>
						<td>Last Name</td>
						<td><input type="text" name="owner_lname" size="30" value="${o.getOwner_lname()}"/></td>
					...
					<tr>
						<td>Email Id:</td>
						<td><input type="mail" name="owner_email" size="30" value="${o.getOwner_gmail()}" /></td>
					</tr>
					<tr>
						<td>Phone Number:</td>
						<td><input type="text" name="owner_phno" size="30" value="${o.getOwner_phno()}"/></td>
					</tr>
					<tr>
						<td>SSN</td>
